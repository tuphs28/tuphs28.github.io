...
![PDF](/assets/images/intro_mc/pdf_exp.png)
...
![MC estimates](/assets/images/intro_mc/basic_mc_est.png)
...
![MC estimates](/assets/images/intro_mc/multi_mc_est.png)
...
![PDF vs f](/assets/images/intro_mc/high_energy_pdf.png)
...
![High energy MC estimate](/assets/images/intro_mc/high_energy_mc_est.png)
...
![High energy MC variance](/assets/images/intro_mc/high_energy_var.png)
...
I'm not including this proof to stop this post from getting too long, but proving this just requires showing that the new integrand's variance has a lower bound (via Jensen's inequality) and then showing that this if we choose this q then the lower bound is achieved.
...
![IS Dist](/assets/images/intro_mc/is_dist.png)
...
![IS Convergence](/assets/images/intro_mc/is_conv.png)
...
![IS variance](/assets/images/intro_mc/is_var.png)
...
![control variates pdfs](/assets/images/intro_mc/cv_pdf.png)
...
![control variates convergence](/assets/images/intro_mc/cv_conv.png)
...
![control variates variance](/assets/images/intro_mc/cv_var.png)
